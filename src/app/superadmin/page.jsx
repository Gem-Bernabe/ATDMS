...
export default function SuperAdminDashboard() {
  ...
  const filteredAccommodations =
    selectedMunicipality === "All"
      ...
      : sortedAccommodations.filter(
          (acc) => acc.municipality === selectedMunicipality
        );

  const stats = {
    total: filteredAccommodations.length,
    pending: filteredAccommodations.filter((acc) => acc.status === "Pending")
      .length,
    approved: filteredAccommodations.filter((acc) => acc.status === "Approved")
      .length,
  };
